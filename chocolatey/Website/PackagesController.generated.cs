...
namespace NuGetGallery {
    public partial class PackagesController {
        ...
        public class ActionNamesClass {
            ...
            public readonly string MarkOutdated = "MarkOutdated";
            public readonly string MarkBroken = "MarkBroken";
        }
    ...
    public class T4MVC_PackagesController: NuGetGallery.PackagesController {
        ...
        public override System.Web.Mvc.ActionResult MarkOutdated(string id, string version)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.MarkOutdated);
            callInfo.RouteValueDictionary.Add("id", id);
            callInfo.RouteValueDictionary.Add("version", version);
            return callInfo;
        }

        public override System.Web.Mvc.ActionResult MarkOutdated(string id, string version, NuGetGallery.PackageOutdatedViewModel form)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.MarkOutdated);
            callInfo.RouteValueDictionary.Add("id", id);
            callInfo.RouteValueDictionary.Add("version", version);
        ...
        public override System.Web.Mvc.ActionResult MarkBroken(string id, string version)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.MarkOutdated);
            callInfo.RouteValueDictionary.Add("id", id);
            callInfo.RouteValueDictionary.Add("version", version);
        ...
        public override System.Web.Mvc.ActionResult MarkBroken(string id, string version, NuGetGallery.PackageBrokenViewModel form)
        {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.MarkOutdated);
            callInfo.RouteValueDictionary.Add("id", id);
            callInfo.RouteValueDictionary.Add("version", version);
